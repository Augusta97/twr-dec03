      ...
      <b-col md="10" class="mb-2 form-bg">
        ...
        <div>
          <b-form
            ...
            @submit.prevent="createNewSidebarMenu"
          >
            <b-row>
              <b-form-group class="col-sm-12">
                <h5>Create New Sidebar Menu</h5>
              </b-form-group>
            </b-row>
            <b-row>
      ...
      if (localStorage.getItem("userId") == null) {
        ...
        this.$validator.validateAll().then((valid) => {
          if (valid && !this.titleExists) {
            const payload = {
              // ID: this.allSidebarMenu.length + 1,
            ...
            this.createSidebarMenu(payload);
