      ...
      <b-col md="10" class="mb-2 form-bg">
        ...
        <div>
          <b-form
            ...
            @submit.prevent="editSidebarMenu"
          >
            <b-row>
              <b-form-group class="col-sm-12">
                <h5 v-if="$route.params.view === 'view'">View Sidebar Menu</h5>
                <h5 v-else>Edit Sidebar Menu</h5>
              </b-form-group>
            </b-row>
                  ...
                  <b-col>
                    ...
                    >
                      <b-form-select
                        ...
                        :class="{
                          input: true,
                          'is-danger': errors.has('parentMenu'),
                        }"
                      >
                  ...
                  <b-col v-if="formData.parentMenu == 0">
                    ...
                    >
                      <b-form-select
                        ...
                        :class="{
                          input: true,
                          'is-danger': errors.has('parentMenuId'),
                        }"
                      >
                        <option class="disable" disabled value>Select</option>
                        <option
                          v-for="(side, index) in allSidebarMenu"
                          :key="index"
                          :value="side.ID"
                        >
                          {{ side.name }}
                ...
                <b-row>
                  ...
                  >
                    <b-form-select
                      ...
                      :class="{
                        input: true,
                        'is-danger': errors.has('menuOrder'),
                      }"
                    >
                      <option class="disable" disabled value>Select</option>
            ...
            <b-form-group class="col-sm-12 text-right">
              <router-link to="/viewSidebarMenu">
...
export default {
  ...
  computed: {
    ...mapState(["existinglang", "allSidebarMenu", "allPages"]),
    commonIndex() {
      if (this.allSidebarMenu !== null && this.allSidebarMenu.length !== 0) {
        return this.allSidebarMenu.findIndex(
  ...
  methods: {
    titleCheck() {
      let pa = this.allSidebarMenu.findIndex(
        (x) => x.name === this.formData.name
      );
      if (pa !== -1) {
    ...
    ...mapActions(["editSidebarMenuById"]),
      ...
      this.$validator.validateAll().then((valid) => {
        if (valid && !this.titleExists) {
          const payload = {
            ...
            ID: this.allSidebarMenu[this.commonIndex].ID,
            engId: this.allSidebarMenu[this.commonIndex].engId,
            name: this.formData.name,
            labelDesc: this.formData.labelDesc,
            labelImage:
              this.formData.bannerImageUrl === ""
                ? this.allSidebarMenu[this.commonIndex].labelImage
                : this.formData.bannerImageUrl,
          ...
          this.editSidebarMenuById(payload);
    ...
    handleOk(bvModalEvt) {
      ...
      this.$router.push({ path: "/ViewSidebarMenu/" });
    },
  },
  created() {
    this.formData.name = this.allSidebarMenu[this.commonIndex].name;
    this.formData.bannerImageUrl =
      this.allSidebarMenu[this.commonIndex].labelImage !== ""
        ? this.allSidebarMenu[this.commonIndex].labelImage
        : "";
    this.formData.labelDesc = this.allSidebarMenu[this.commonIndex].labelDesc;
    this.formData.pageId = this.allSidebarMenu[this.commonIndex].pageId;
    this.formData.parentMenu = this.allSidebarMenu[this.commonIndex].parentMenu;
    this.formData.subMenu = this.allSidebarMenu[this.commonIndex].subMenu;
    this.formData.parentMenuId = this.allSidebarMenu[
      this.commonIndex
    ].parentMenuId;
    this.formData.menuOrder = this.allSidebarMenu[this.commonIndex].menuOrder;
  },
};
</script>
