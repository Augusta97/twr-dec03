        ...
        <div>
          ...
          >
                ...
                <b-form-group class="col-sm-12">
                  ...
                  <div class="dashborder mt-3">
                    ...
                    <input
                      ...
                      ref="fileaudio"
                    />
                    <span v-show="audioErr" class="help is-danger ml-2">{{
                      audioErr
                    }}</span>
                  </div>
                </b-form-group>
                <b-form-group class="col-sm-12">
                  ...
                  <div class="dashborder mt-3">
                    ...
                    <input
                      ...
                      ref="filevideo"
                    />
                    <span v-show="videoErr" class="help is-danger ml-2">{{
                      videoErr
                    }}</span>
                  </div>
                </b-form-group>
                <b-form-group class="col-sm-12">
                  ...
                  <div class="dashborder mt-3">
                    ...
                    <input
                      ...
                      ref="filepdf"
                    />
                    <span v-show="pdfErr" class="help is-danger ml-2">{{
                      pdfErr
                    }}</span>
                  </div>
                </b-form-group>
                ...
                <b-row>
                  ...
                  >
                    <b-form-select
                      ...
                      :class="{
                        input: true,
                        'is-danger': errors.has('mediaClassification'),
                      }"
                    >
                      <option value="0">None</option>
                      <option
            ...
            <b-form-group class="col-sm-12 text-right">
              <router-link to="/viewGeneralMedia">
  ...
  methods: {
        ...
        this.$validator.validateAll().then((valid) => {
          if (valid && !this.titleExists) {
            const payload = {
              ...
              pdfUrl: this.formData.pdfUrl,
              videoUrl: this.formData.videoUrl,
              audioUrl: this.formData.audioUrl,
              // quiz: this.formData.quiz,
              addedBy: localStorage.getItem("userId"),
              editedBy: localStorage.getItem("userId"),
            };
            this.createNewMedia(payload);
    ...
    handleFileUpload(i) {
      if (localStorage.getItem("userId") == null) {
        ...
        if (i === 0) {
          this.extension =
            this.$refs.file.files[0] !== undefined
              ? this.$refs.file.files[0].name.substring(
          ...
          if (this.acceptedVideo.includes(this.extension)) {
            ...
            self.progress.videoUpload = false;
            this.videoErr =
              "Video field must be an (.mp4 or .mpeg) file format";
          }
        } else if (i === 3) {
          this.extension =
            this.$refs.filepdf.files[0] !== undefined
              ? this.$refs.filepdf.files[0].name.substring(
                  this.$refs.filepdf.files[0].name.lastIndexOf(".")
                )
              : "";
          if (this.acceptedPdf.includes(this.extension)) {
            this.pdfErr = false;
            ...
            this.pdfErr = "Pdf field must be an (.pdf) file format";
            self.progress.pdfUpload = false;
          }
        }
      }
