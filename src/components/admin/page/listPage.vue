        ...
        <b-container fluid class="bg-white">
          <b-row class="form-height">
            <b-col md="12" class="mb-2 pt-2">
              ...
              <b-col v-if="allPages && allPages.row && allPages.row.length">
                <b-table
                  ...
                  <template v-slot:cell(action)="row">
                    <div class="action-cls">
                      ...
                      <i
                        ...
                        v-b-tooltip.hover
                        title="edit"
                        class="fa fa-edit action-icons edit-active"
                      ></i>
                      <i
              ...
              <div
                class="viewtable-width"
                v-if="allPages && allPages.row && allPages.row.length"
              >
                <b-col md="6" class="my-1">
                  <b-pagination
                    v-model="currentPage"
                    :total-rows="allPages.row.length"
                    :per-page="perPage"
                    class="my-0"
                  ></b-pagination>
                </b-col>
  ...
  methods: {
    ...
    viewPage(ID) {
      if (localStorage.getItem("userId") == null) {
        ...
        this.$router.push({ path: "/EditPage/" + ID + "/view" });
      }
    },
  },
  computed: {
