          ...
          <b-tabs card class="clrtab">
            <b-tab no-body title="High" @click="HighClk()">
              <b-card-text class="col-sm-12 mt-5" v-if="help">
                <b-row
                  v-for="(helps, index) in help.filter(
                    (x) => x.priority == 'HIGH' && x.answered == 0
                  )"
                  :key="index"
                >
                  <b-col lg="3" md="3">
                  ...
                  <b-col lg="2" sm="3">
                    <p>
                      {{
                        helps.createdAt.substr(0, 10) +
                        " " +
                        helps.createdAt.substr(11, 5)
                      }}
                    </p>
                  </b-col>
                  <b-row v-if="helps.id == uniqueId" class="mx-1 mb-4">
                    ...
                    <b-col
                      sm="2"
                      v-for="(attach, i) in helpAttachment.attachment"
                      :key="i"
                    >
                      <b-img
                        v-if="attach != null"
            ...
            <b-tab no-body title="Medium" @click="MediumClk()">
              <b-card-text class="col-sm-12 mt-5" v-if="help">
                <b-row
                  v-for="(helps, index) in help.filter(
                    (x) => x.priority == 'MEDIUM' && x.answered == 0
                  )"
                  :key="index"
                >
                  <b-col lg="3" md="3">
                    ...
                    <b-col lg="10" md="12">
                      <b-row class="ques-style">
                        <b-col lg="3" md="4">
                          <h6>
                            {{
                              helps.appuser_fname + " " + helps.appuser_lname
                            }}
                          </h6>
                          <h6>
                            <b>ph:</b>
                        ...
                        <b-row class="mx-2 mb-4">
                          ...
                          <b-col
                            sm="2"
                            v-for="(attach, i) in helps.attachment"
                            :key="i"
                          >
                            <b-img
                              v-if="attach != null"
                    ...
                    <b-col sm="10">
                      <b-row class="ans-style">
                        ...
                        <b-col lg="3" sm="4">
                          <h6>
                            {{
                              helpans.adminuser_fname +
                              " " +
                              helpans.adminuser_lname
                            }}
                          </h6>
                          <p>
                            {{
                              helpans.createdAt.substr(0, 10) +
                              " " +
                              helpans.createdAt.substr(11, 5)
                            }}
                          </p>
                        </b-col>
                        <b-row class="mx-2 mb-4">
                          ...
                          <b-col
                            sm="2"
                            v-for="(attach, i) in helpans.ansattachment"
                            :key="i"
                          >
                            <b-img
                              v-if="attach != null"
