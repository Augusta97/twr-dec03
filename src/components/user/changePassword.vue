        ...
        <div class="modal-body changepass-padd">
          ...
          <b-row class="form-group margin-space">
            ...
            <b-form-input
              ...
              :class="{
                'form-control': true,
                'is-danger': errors.has('confirmPass'),
              }"
              class="col-sm-8"
              @keypress="confirmPassPress"
            />
            <span v-show="errors.has('confirmPass')" class="help is-danger">{{
              errors.first("confirmPass")
            }}</span>
          </b-row>
          <b-form-group class="height15">
            <p class="invalid-cls text-center" v-if="errorPassword">
              Invalid password
            </p>
            <p class="invalid-cls text-center" v-if="successPassword">
