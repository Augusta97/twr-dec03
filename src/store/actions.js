...
export default {
  ...
  loadSectionByCourseId: ({ commit }, payload) => {
    const auth = {
      headers: {
        "x-access-token": localStorage.getItem("authToken"),
      },
  ...
  logout: ({ commit }) =>
    HTTP.get("user/logout", {
      params: {
        userId: localStorage.getItem("userId"),
        cms: "yes",
        emailOrPhone: localStorage.getItem("email")
  ...
  loadExistingPrayerGroup: ({ commit }) => {
  ...
  loadExistingPrayerTitle: ({ commit }, payload) => {
  ...
  loadExistingPrayerDescription: ({ commit }, payload) => {
  ...
  loadExistingGeneralSettings: ({ commit }) => {
    const auth = {
      headers: {
        "x-access-token": localStorage.getItem("authToken"),
      },
  ...
  loadExistingSidebarMenu: ({ commit }) => {
  ...
  loadMediaClassification: ({ commit }) => {
  ...
  loadChapterByBook: ({ commit }, payload) => {
  ...
  loadExistingReading: ({ commit }, payload) => {
  ...
  loadHelpAttachment: ({ commit }, payload) => {
    // var x = "HIGH";
  ...
  loadgrpUploadAttachments: ({ commit }, payload) => {
  ...
  editGroupAttendance: ({ commit }, payload) => {
  ...
  assignMemberRoleAndGroup: (payload) => {
  ...
  addMediaClassification: (payload) => {
    const auth = {
      headers: {
        "x-access-token": localStorage.getItem("authToken"),
      },
  ...
  editMediaClassification: (payload) => {
    const auth = {
      headers: {
        "x-access-token": localStorage.getItem("authToken"),
      },
  ...
  deleteMediaClassification: (payload) => {
    const auth = {
      headers: {
        "x-access-token": localStorage.getItem("authToken"),
      },
  ...
  addDenomination: ({ commit }, payload) => {
    const auth = {
      headers: {
        "x-access-token": localStorage.getItem("authToken"),
      },
  ...
  editDenomination: ({ commit }, payload) => {
    const auth = {
      headers: {
        "x-access-token": localStorage.getItem("authToken"),
      },
  ...
  deleteDenomination: ({ commit }, payload) => {
    const auth = {
      headers: {
        "x-access-token": localStorage.getItem("authToken"),
      },
  ...
  createPrayerDescription: (payload) => {
  ...
  editGeneralizationById: ({ commit }, payload) => {
  ...
  thankfulPrayerGroup: ({ commit }, payload) => {
  ...
  deletePrayerDescription: (payload) => {
